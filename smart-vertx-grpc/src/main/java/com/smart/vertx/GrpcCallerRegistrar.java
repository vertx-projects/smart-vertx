 ...
 */
@Slf4j
public abstract class GrpcCallerRegistrar<T extends Annotation> implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata,
        ...
        Class<T> annotationClass = (Class<T>) GenericTypeResolver.resolveTypeArgument(this.getClass(), GrpcCallerRegistrar.class);
